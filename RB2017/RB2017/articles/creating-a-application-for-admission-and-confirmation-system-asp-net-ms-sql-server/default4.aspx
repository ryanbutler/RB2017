...
<h3>Create the Stored Procedure for High School</h3>
<p>If you still have the database on your task menu, simply restore it. From the Object Explorer, follow these steps to create the procedure for high school:</p>
<ol>
<li>Expand the plus sign (+) next to our database, ApplicantAdmission.</li>
...
-- =============================================
ALTER PROCEDURE [dbo].[spHighSchoolGetSchools] 
...
<li>In the name text field, type HighSchool.cs.</li>
<li>Click add.</li>
</ol>
<p>Double click HighSchool.cs from the Solution Explorer, which will show the empty class as shown below:</p>
<pre>
<code>
using System;
